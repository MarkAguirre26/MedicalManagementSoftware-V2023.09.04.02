...
namespace MedicalManagement
{
    public static class Tool
    {
        ...
        {
            MessageBox.Show("This feature is temporary not available! Please contact your system developer.", "Invalid", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }


        public static void DeleteTemporaryFilesFromTemplate(string path)
        {
            try
            {
        ...
        public static int ComputeAge(DateTime BirthDate)
        {
            ...
            try
            {
                ...
                int year = Convert.ToInt32((CurrentDate.Year - BirthDate.Year));
                int month = Convert.ToInt32((CurrentDate.Month > BirthDate.Month));
        ...
        internal static Image bytetoimage(Binary picture)
        {
