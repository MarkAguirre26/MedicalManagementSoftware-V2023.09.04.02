...
namespace MedicalManagement.Class
{
    public class Datas
    {
        ...
        public static string FVOD_wo;
        public static string FVOS_wo;
        public static string FVOD_w;
        public static string FVOS_w;
        public static string NEAR_VISUAL;
        ...
        public static string resultXRAY;
