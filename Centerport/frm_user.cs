        ...
        private void cmd_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (cmd_save.Text == "Save")
                {
                    ...
                    var item = db.sp_createUser(txt_name.Text, txt_username.Text, EncodeString.Encrypt(txt_password.Text), Levelcn, "1").FirstOrDefault();
                        ...
                        if(item != null){
                            ...
                            cmd_new.Text = "New";
                             ...
                             MessageBox.Show("Usernane already in used", "Action Denied", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        }

                }
                else
                {
                    db.ExecuteCommand("UPDATE tbl_user SET Fullname={0}, Username={1}, Password={2}, UserLevel={3} WHERE (cn={4})", txt_name.Text, txt_username.Text, EncodeString.Encrypt(txt_password.Text), Levelcn, dataGridView1.SelectedRows[0].Cells[0].Value.ToString());
